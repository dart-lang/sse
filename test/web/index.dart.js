...
(function dartProgram() {
  ...
  M = {
    SseClient$: function(serverUrl) {
      ...
      t1 = new M.SseClient(P.StreamController_StreamController(t1), P.StreamController_StreamController(t1), F.Logger_Logger("SseClient"), P.StreamController_StreamController(t1));
  ...
  P._StreamController.prototype = {
    ...
    _subscribe$4: function(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new P._ControllerSubscription(_this, onData, t4, type$.void_Function._as(t5), t2, t3, t1._eval$1("_ControllerSubscription<1>"));
  ...
  M.SseClient.prototype = {
    SseClient$1: function(serverUrl) {
      ...
      _this._startPostingOrderedMessages$0();
    },
    close$0: function(_) {
    ...
    _startPostingOrderedMessages$0: function() {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.dynamic),
        $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, message, t2, t1, $async$temp1;
      var $async$_startPostingOrderedMessages$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = new P._StreamIterator(t1, type$._StreamIterator_legacy_String);
              P.ArgumentError_checkNotNull(t1, "stream", type$.Stream_legacy_String);
              $async$handler = 2;
            case 5:
              // for condition
              $async$temp1 = H;
              $async$goto = 7;
              return P._asyncAwait(t2.moveNext$0(), $async$_startPostingOrderedMessages$0);
            case 7:
              ...
              $async$goto = 8;
              return P._asyncAwait($async$self._encodeAndSend$1(message), $async$_startPostingOrderedMessages$0);
            case 8:
              // returning from await.
              // goto for condition
              $async$goto = 5;
            ...
            case 3:
              ...
              $async$handler = 1;
              $async$goto = 9;
              return P._asyncAwait(t2.cancel$0(), $async$_startPostingOrderedMessages$0);
            case 9:
              // returning from await.
      ...
      return P._asyncStartSync($async$_startPostingOrderedMessages$0, $async$completer);
    },
    _encodeAndSend$1: function(message) {
      return this._encodeAndSend$body$SseClient(message);
    },
    _encodeAndSend$body$SseClient: function(message) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, e, e0, exception, t1, $async$exception;
      var $async$_encodeAndSend$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$currentError = $async$result;
          $async$goto = $async$handler;
        }
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $async$goto = 6;
              return P._asyncAwait(W.HttpRequest_request($async$self._serverUrl, "POST", C.C_JsonCodec.encode$2$toEncodable(message, null), true), $async$_encodeAndSend$1);
            case 6:
              // returning from await.
              $async$handler = 1;
              // goto after finally
      ...
      return P._asyncStartSync($async$_encodeAndSend$1, $async$completer);
    }
  };
  ...
  E.main_closure0.prototype = {
    call$1: function(s) {
      H._asStringS(s);
      this.channel._encodeAndSend$1(s);
    },
    $signature: 29
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance_1_u(_ = P._StreamIterator.prototype, "get$_onData", "_onData$1", 21);
    ...
    _instance_1_u(_, "get$_onOutgoingMessage", "_onOutgoingMessage$1", 27);
  })();
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "Null()", "~(@)", "~(Object,StackTrace)", "~(~())", "@(@)", "Null(@)", "Null(Object?,Object?)", "Null(Symbol0,@)", "String(int)", "~(Event*)", "Null(Event*)", "Null(String,@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "Null(int,@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "Null(ProgressEvent)", "@(Event)", "@(@,@)", "Null(@,@)", "Logger*()", "~(String*)", "Null(MouseEvent*)", "Null(String*)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Stream_legacy_String: findType("Stream<String*>"),
      ...
      _StreamIterator_legacy_String: findType("_StreamIterator<String*>"),
      bool: findType("bool"),
